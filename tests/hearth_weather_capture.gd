...
const SHOTS := [
	["day-clear", 9.5, "clear", 4.0],
	["day-rain", 9.5, "light_rain", 4.0],
	["night-clear", 22.0, "clear", 4.0],
	["night-rain-a", 22.0, "light_rain", 4.0],
	["night-rain-b", 22.0, "light_rain", 5.0],
]
...
func _record() -> void:
	var output_dir := "res://temp/hearth-weather"
